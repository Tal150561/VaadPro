...
(function () {
  ...
  },
  {
    ...
    body:
      ...
      '<h3>אם דיירים לא מקבלים הודעות (וי אחד / "ממתין להודעה זו")</h3>' +
      '<p>לפעמים ההודעה נשלחת (וי אחד אצלכם) אך הדייר רואה <em>"ממתין להודעה זו"</em> ולא מקבל אותה — תקלת הצפנה זמנית מצד WhatsApp. VaadPro <strong>מנסה לשלוח מחדש אוטומטית</strong>, ורוב המקרים נפתרים תוך שניות ללא התערבות.</p>' +
      '<div class="vpg-box warn"><div class="bt">🟠 באנר כתום "ייתכן שהודעות לא נמסרו"</div>אם המערכת מזהה שכמה הודעות רצופות לא נמסרו — יופיע באנר כתום בראש המסך. הפתרון: לחצו <strong>"אפס חיבור וסרוק"</strong> בבאנר וסרקו ברקוד חדש. זה מייצר חיבור נקי וההודעות חוזרות להישלח כרגיל.</div>' +
  ...
  },
  {
    ...
    body:
      ...
      '<div class="vpg-box tip"><div class="bt">💡 ייבוא לחודש שכבר נסגר</div>כשמייבאים קובץ בנק וה<strong>חודש הנבחר סגור</strong>, המערכת לא מפצלת ולא שואלת — מלוא התשלום של כל דייר יורד ישירות לפאנל ההכרעה כשורה אחת, ומשם נזקף לחוב באישורך. (ייבוא לחודש פתוח ממשיך לפעול כרגיל.)</div>' +
      '<h3>תשלום שהתקבל עבור חודש שכבר נסגר</h3>' +
      '<p>לפעמים תשלום מגיע <strong>אחרי</strong> שהחודש שלו כבר נסגר — למשל דייר משלם את יולי ב-7 בספטמבר, כשיולי כבר נסגר וחובו כבר נצבר לחוב המצטבר. במקרה כזה המערכת <strong>לא כותבת את התשלום בשקט</strong> על החודש הסגור (זה היה גורם לכפילות — החוב נצבר וגם התשלום נרשם).</p>' +
      '<p><strong>מה קורה בפועל בייבוא בנק ידני:</strong> אחרי אישור הייבוא מופיע <strong>פאנל הכרעה</strong> עם שורת החלטה לכל תשלום. כל שורה מציגה: 🏦 <strong>הטקסט המקורי מהבנק</strong> (שם המשלם וההערה), 🏷️ <strong>למה השורה כאן</strong>, ו-👁️ <strong>מה יקרה אם תזקוף</strong> (למשל: "החוב יקטן מ-460 ל-260 ₪" או "העודף יהפוך לזכות"). לכל שורה שני כפתורים:</p>' +
      '<ul><li><strong>✅ לזקוף</strong> — זוקף את <strong>מלוא התשלום</strong> כנגד החוב: קודם נסגר החוב של אותו חודש וכל חוב פתיחה קודם, ואם נשאר עודף הוא הופך ל<strong>יתרת זכות</strong>. פעם אחת בלבד, עם הערת שקיפות מתועדת.</li>' +
      '<li><strong>התעלם</strong> — לא משנה דבר. התשלום נשאר ללא רישום, ואפשר לטפל בו מאוחר יותר.</li></ul>' +
      '<div class="vpg-box tip"><div class="bt">⚡ פעולות מהירות (לבניינים גדולים)</div>מעל הרשימה יש כפתורי <strong>"זקוף מסומנים" / "התעלם ממסומנים"</strong> ותיבת <strong>"בחר הכל"</strong>. המערכת <strong>מסמנת מראש אוטומטית</strong> את השורות הבטוחות — סכומים שתואמים דמי-ועד רגילים (או כפולה נקייה שלהם). שורות עם סכום או הערה חריגים נשארות <u>לא מסומנות</u> כדי שתעברו רק עליהן. כך במקום ללחוץ על 100 שורות אחת-אחת, בודקים 2-3 חריגים ולוחצים "זקוף מסומנים".</div>' +
      '<div class="vpg-box ok"><div class="bt">✅ דוגמה</div>אור שילם 1000 ₪ (דמי חודש 200, בלי חוב קודם) עבור אוגוסט שכבר נסגר → בזקיפה: 200 סוגרים את אוגוסט, ו-800 הנותרים הופכים ל<strong>יתרת זכות</strong>. אילו היה לו חוב קודם 300 — קודם הוא היה נסגר, והזכות הייתה 500.</div>' +
      '<div class="vpg-box tip"><div class="bt">💡 למה צריך אישור?</div>זקיפה אוטומטית לחוב סגור פירושה נגיעה בכסף בשקט — בדיוק סוג הפעולה שעלול ליצור זכות מדומה. לכן המערכת עוצרת ושואלת. הזקיפה מוגנת כך שגם לחיצה כפולה, ריענון הדף, או ייבוא חוזר של אותו קובץ <strong>לעולם לא</strong> יקטינו את החוב פעמיים.</div>' +
      '<div class="vpg-box warn"><div class="bt">⚠️ ייבוא אוטומטי (BankSync)</div>בייבוא האוטומטי אין מי שילחץ "לזקוף". לכן הסוכן <strong>לעולם לא</strong> זוקף לבד — הוא מזהה תשלום לחודש סגור, משאיר אותו כיתרת זכות, ומסמן אותו כדי שתטפלו בו ידנית מאוחר יותר.</div>' +
      '<h3>שורה אחת שמתאימה ליותר מדייר אחד (הכרעת שיוך)</h3>' +
      '<p>לפעמים שורת בנק מתאימה ל<strong>כמה דיירים</strong> ואי אפשר לדעת ודאית למי היא שייכת — למשל שני דיירים בשם "כהן" ללא מספר דירה שמפריד, או שורה שכתוב בה רק שם משפחה משותף ("ברקן") בלי שם פרטי. <strong>מתי זה קורה:</strong> בכל ייבוא בנק (ידני), אחרי שלב הזיהוי, אם נשארה שורה עם 2+ מועמדים שווים.</p>' +
      '<p><strong>מה המערכת עושה לבד קודם:</strong> ברוב המקרים היא כן מכריעה אוטומטית — לפי שם מלא בשורה ("נועה ברקן" → נועה), לפי מספר מילות חיפוש שתואמות, או לפי מספר דירה/גוש-חלקה בהערה. רק כשכל אלה נכשלים ונשאר תיקו אמיתי — השורה יורדת ל<strong>פאנל ההכרעה</strong>.</p>' +
      '<p><strong>מה לעשות:</strong> בפאנל "🔀 תשלומים דורשים הכרעה" כל שורה מציגה 🏦 הטקסט מהבנק + 💰 הסכום, ולכל מועמד כפתור נפרד עם המבחין שלו — <strong>"זקוף ל־כהן א (דירה 4)"</strong> מול <strong>"זקוף ל־כהן ב (דירה 11)"</strong> (בקיבוץ: גוש/חלקה). בחר את המועמד הנכון, או <strong>"התעלם"</strong>. אחרי שבחרת לכל השורות — גלול למעלה ולחץ <strong>"✅ אשר ורשום"</strong> כדי לרשום את הכל יחד.</p>' +
      '<div class="vpg-box ok"><div class="bt">✅ התוצאה</div>כל תשלום נזקף לדייר שבחרת. אם זקפת <strong>כמה שורות לאותו דייר</strong> — הן <strong>מצטברות</strong> (300+150 = 450), ואם לדייר כבר שויך תשלום אוטומטית — ההכרעה הידנית מתווספת אליו (230 אוטומטי + 500 ידני = 730). בסיום מופיע סיכום: "✅ N שויכו ידנית".</div>' +
      '<div class="vpg-box tip"><div class="bt">💡 איך למנוע מראש</div>אם אותם שני דיירים מופיעים שוב ושוב בפאנל — הוסיפו להם <strong>מספר דירה</strong> (בקיבוץ: גוש/חלקה) שונה בטאב דיירים. אז המערכת תוכל להכריע לבד לפי ההערה בבנק. כפתור <strong>"🔎 בדוק מילות חיפוש"</strong> בראש רשימת הדיירים מראה מראש אילו דיירים חולקים מילת חיפוש בלי מבחין.</div>' +
      '<div class="vpg-box warn"><div class="bt">⚠️ ייבוא אוטומטי (BankSync)</div>גם כאן הסוכן <strong>לעולם לא מנחש</strong> — שורה עמומה נשמרת בתור ומחכה שתכריעו עליה ידנית, במקום להירשם לדייר שגוי.</div>' +
      '<h3>תור ההכרעות של הסוכן האוטומטי (BankSync)</h3>' +
      '<p>כשהסוכן האוטומטי נתקל בשורה עמומה, הוא שומר אותה ב<strong>תור</strong> במקום לנחש. בכניסה הבאה שלכם למערכת יופיע פאנל <strong>"🤖 תשלומים מהסוכן האוטומטי דורשים הכרעה"</strong> — בדיוק כמו פאנל ההכרעה הידני, עם כפתור לכל מועמד (כולל מספר הדירה) + "התעלם". בחירה זוקפת מיד את התשלום לדייר שבחרתם.</p>' +
      '<div class="vpg-box tip"><div class="bt">💡 הגנה מפני התנגשות</div>אם אתם מייבאים <strong>אותו קובץ</strong> גם דרך הסוכן וגם ידנית — אין סכנה של רישום כפול. שורה שכבר נרשמה בייבוא ידני <strong>לא תופיע</strong> בתור הסוכן (המערכת מזהה אותה לפי חתימה ייחודית ומסירה אותה אוטומטית).</div>' +
      '<h3>השהיית הסוכן האוטומטי</h3>' +
      '<p>בבאנר של BankSync יש כפתור מתחלף <strong>"▶️ פעיל — השהה"</strong>. לחיצה משהה את הסוכן: כל עוד הוא מושהה, ריצה אוטומטית תידחה ולא תעלה תשלומים. שימושי כשאתם רוצים לייבא ידנית בלי שהסוכן ירוץ במקביל. לחיצה חוזרת (<strong>"⏸️ מושהה — הפעל"</strong>) מחזירה אותו לפעולה.</p>'
  },
  {
  ...
  },
  {
    ...
    body:
      ...
      '<h3 id="vpg-a-set-undo">↩️ ביטול ייבוא הבנק האחרון</h3>' +
      '<p>מקטע צהוב מכווץ בתחתית ההגדרות. מחזיר את הבניין <strong>למצב שהיה רגע לפני ייבוא קובץ הבנק האחרון</strong> — גם ייבוא ידני (גרירת קובץ ו"אשר ורשום") וגם ייבוא אוטומטי של BankSync.</p>' +
      '<ul><li><strong>🔍 בדוק מה יבוטל</strong> — בדיקה בלבד, לא משנה שום נתון. מציג מתי היה הייבוא, מאיזה מקור, לאיזה חודש ואילו דיירים הוא רשם — או מסביר למה הביטול חסום.</li>' +
      '<li><strong>↩️ בטל ייבוא אחרון</strong> — מבטל את התשלומים, הסטטוסים וזיכרון הייבוא (כולל חשבונות נוספים) שהייבוא האחרון רשם, ומחזיר את מה שהיה לפניו. גיבוי אוטומטי נשמר לפני הביטול.</li></ul>' +
      '<p><strong>מתי להשתמש:</strong> ייבאתם קובץ שגוי, בחרתם חודש לא נכון, או שתשלומים שויכו לדיירים הלא נכונים. מבטלים, מתקנים (חודש / מילות חיפוש), ומייבאים שוב.</p>' +
      '<div class="vpg-box tip"><div class="bt">1️⃣ רק האחרון, רק פעם אחת</div>אפשר לבטל רק את הייבוא האחרון. אחרי ביטול אין "ביטול נוסף" לייבוא שלפניו. ריצה אוטומטית של BankSync שלא מצאה תשלומים חדשים <strong>לא</strong> נחשבת ייבוא ולא מוחקת את אפשרות הביטול — וכך גם ייבוא ידני שכל התנועות בו כבר יובאו בעבר.</div>' +
      '<div class="vpg-box tip"><div class="bt">ℹ️ "אין ייבוא לביטול" למרות שיש תשלומים?</div>ביטול אפשרי רק לייבוא שרשם תשלומים חדשים <strong>מאז עדכון המערכת</strong> (גרסה 2.14.53) — ייבואים ישנים יותר לא שמרו את המידע הדרוש לביטול. זה קורה גם אם הייבוא האחרון כבר בוטל, או שבוצעה "התחלה נקייה" מאז. לתיקון ייבוא ישן — 🧹 "התחלה נקייה" ואז ייבוא מחדש.</div>' +
      '<div class="vpg-box danger"><div class="bt">⛔ מתי הביטול חסום</div><strong>(1) נסגר חודש אחרי הייבוא</strong> — התשלומים כבר נכנסו ליתרות הדיירים ואי אפשר להפריד אותם. לתיקון דייר בודד: ערכו את "יתרת הפתיחה" שלו; לתיקון כללי — פנו לתמיכה.<br><strong>(2) שיניתם ידנית אחרי הייבוא משהו שהוא רשם</strong> (למשל "בטל" או סימון תשלום לדייר, או הכרעה ברשימת התשלומים הממתינים) — המערכת מציגה את שמות הדיירים שהשתנו. החזירו את השינוי הידני ונסו שוב, <strong>או</strong> השתמשו ב-🧹 "התחלה נקייה" ואז ייבאו מחדש את קבצי הבנק הנכונים — בלי צורך בתמיכה.</div>' +
      '<div class="vpg-box ok"><div class="bt">🛡️ בטוח</div>הביטול מחזיר בדיוק את מה שהייבוא שינה — לא נוגע בחוב ההתחלתי, ברשימת הדיירים או בהגדרות. אם משהו לא מתאים — הוא נחסם ולא מבצע חצי פעולה.</div>' +
      '<div class="vpg-box tip"><div class="bt">↩️ לעומת 🧹</div><strong>ביטול ייבוא</strong> = צעד אחד אחורה (רק הייבוא האחרון). <strong>התחלה נקייה</strong> = מחיקת <strong>כל</strong> הייבואים מאז ומעולם.</div>' +
      ...
      '<p><strong>לא נמחק:</strong> רשימת הדיירים, הטלפונים, מילות החיפוש, התשלום החודשי המותאם, <strong>החוב ההתחלתי (יתרת פתיחה)</strong>, והגדרות הבניין.</p>' +
      '<div class="vpg-box ok"><div class="bt">♻️ ניתן לשחזור</div>כל מה שנמחק כאן חוזר פשוט על ידי <strong>ייבוא מחדש של קובץ הבנק</strong> — ולכן זו פעולה בטוחה יחסית. גיבוי אוטומטי נשמר לפני המחיקה בכל מקרה.</div>' +
      '<div class="vpg-box tip"><div class="bt">💡 טעית בחוב התחלתי של דייר?</div>אל תשתמשו בכלי הזה. לתיקון יתרת פתיחה של דייר בודד — <strong>ערכו את הדייר</strong> (שדה "יתרת פתיחה"), או <strong>ייבאו קובץ דיירים מעודכן</strong> עם החובות הנכונים. שתי הדרכים מדויקות ובטוחות. ניקוי מלא של הבניין (כולל חוב התחלתי ותעריפים) מתבצע רק דרך התמיכה.</div>' +
      '<div class="vpg-box tip"><div class="bt">📥 מייבאים קובץ חברים עם חוב התחלתי "נכון להיום"?</div>ייבוא קובץ חברים <strong>לא מוחק תשלומים שכבר נקלטו</strong>. המערכת מקזזת תשלום בנק קיים מהחוב ההתחלתי — לכן אם הקובץ כבר משקף את המצב העדכני (כולל אותם תשלומים), התשלום ייספר פעמיים והחוב יוצג נמוך מהקובץ. במקרה כזה: <strong>קודם 🧹 התחלה נקייה, ורק אחר כך ייבוא קובץ החברים</strong>. בדיקה מהירה: אחרי הייבוא כל הסטטוסים צריכים להיות "ממתין" והחובות זהים לקובץ.</div>' +
