...
(function () {
  ...
  },
  {
    ...
    body:
      ...
      '<ul><li><strong>✅ לזקוף לחוב</strong> — מקטין את החוב המצטבר בדיוק בדמי אותו חודש, פעם אחת בלבד, ומסמן את החודש כשולם. מופיעה הערת שקיפות מתועדת.</li>' +
      '<li><strong>התעלם</strong> — לא משנה דבר. התשלום נשאר כיתרת זכות של הדייר, ואפשר לטפל בו מאוחר יותר.</li></ul>' +
