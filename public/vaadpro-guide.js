...
(function () {
  ...
  },
  {
    ...
    body:
      ...
      '<table class="vpg-t"><tr><th>שם ✅</th><th>טלפון ✅</th><th>מייל</th><th>מילות_חיפוש</th><th>סטטוס</th></tr>' +
      '<tr><td>ישראל כהן</td><td>0501234567</td><td>israel@email.com</td><td>כהן י, דירה 3</td><td>מושהה</td></tr></table>' +
      '<ul><li>שורה ראשונה = כותרות. שם וטלפון חובה, השאר אופציונלי.</li><li>טלפון זהה לא ייווסף פעמיים.</li>' +
      '<li><strong>עמודת "סטטוס"</strong> — ריק או "פעיל" = דייר רגיל; "מושהה" = בהשהיית גבייה (פטור זמני מדמי ועד).</li></ul>' +
      '<div class="vpg-box tip"><div class="bt">⏸ סטטוס בייבוא — חשוב</div>' +
      '<ul style="margin:4px 0;padding-inline-start:18px;">' +
      '<li>אפשר לסמן דיירים כמושהים כבר בקובץ הייבוא — נוח בהקמת בניין חדש עם הרבה דיירים.</li>' +
      '<li><strong>אם עמודת "סטטוס" לא קיימת בקובץ — המערכת לא נוגעת בהשהיות הקיימות.</strong> כך ייבוא רגיל של קובץ ישן לא יבטל בטעות השהיה שהגדרתם ידנית.</li>' +
      '<li>שינוי סטטוס של דייר קיים (מושהה↔פעיל) יוצג כאזהרה בתצוגה המקדימה לפני האישור.</li>' +
      '<li>השהיית <strong>חשבונות נוספים</strong> (ביטוח וכו\u2019) אינה נכללת בייבוא — מתבצעת ידנית בעריכת החשבונות.</li>' +
      '</ul></div>' +
      '<h3>עריכה וייצוא</h3>' +
      ...
      '<h3>⏸ השהיית גבייה (פטור זמני)</h3>' +
      '<p>דייר שלא מתגורר בדירה תקופה ולכן הוחלט לא לחייב אותו — סמנו <strong>"⏸ השהה מגבייה"</strong> בעריכת הדייר. כל עוד הוא מושהה, <strong>דמי הוועד של החודש לא נצברים לחוב</strong> והחודש מסומן "⏸ מושהה מגבייה".</p>' +
      '<div class="vpg-box tip"><div class="bt">💡 חשוב לדעת</div>' +
      '<ul style="margin:4px 0;padding-inline-start:18px;">' +
      '<li><strong>אל תשנו את "סכום" ל-0</strong> — 0 נחשב "ריק" והמערכת תחזור לסכום ברירת המחדל. ההשהיה היא הדרך הנכונה לפטור.</li>' +
      '<li><strong>חוב קודם נשמר</strong> — יתרת פתיחה וחובות מחודשים קודמים ממשיכים להופיע; ההשהיה מקפיאה רק צבירה חדשה קדימה.</li>' +
      '<li><strong>חשבונות נוספים נפרדים</strong> — השהיית דמי הוועד <u>אינה</u> משהה ביטוח/חשמל. כדי לפטור גם אותם, השהו כל חשבון בנפרד (ראו "חשבונות נוספים").</li>' +
      '<li><strong>חזרה לגבייה</strong> — בטלו את הסימון, והחיוב חוזר <strong>מהחודש הנוכחי והלאה</strong>. אין צורך בפעולה נוספת.</li>' +
      '</ul></div>' +
      '<div class="vpg-box ok"><div class="bt">🗓️ מה קורה לחודשי ההשהיה?</div>' +
      'החודשים שבהם הדייר היה מושהה נשארים <strong>פטורים לצמיתות</strong> — הם לא ייגבו רטרואקטיבית גם אחרי שתבטלו את ההשהיה. המערכת סוגרת כל חודש ב-1 לחודש הבא, ומה שהיה מושהה באותו רגע — פטור לתמיד.' +
      '<div style="margin-top:8px;"><strong>דוגמה:</strong> דייר מושהה מרץ–מאי, ביטלתם את ההשהיה ב-10 ביוני → מרץ/אפריל/מאי פטורים לתמיד, ויוני ואילך מחויבים כרגיל.</div>' +
      '<div style="margin-top:8px;"><strong>שימו לב לעיתוי:</strong> אם ביטלתם את ההשהיה עוד לפני סוף החודש, אותו חודש <u>כן</u> ייגבה (הוא נסגר ב-1 לחודש הבא כשההשהיה כבר בוטלה). כדי לגבות חודש שכבר נסגר כפטור — הזינו זאת ידנית ב"יתרת פתיחה".</div>' +
      '</div>'
  },
  {
    ...
    body:
      ...
      '<h3>שליחת תזכורות</h3>' +
      '<div class="vpg-cards">' +
        '<div class="vpg-fcard"><b>💬 WA לכולם</b><span>שולח לכל הדיירים — <strong>ללא יוצא מן הכלל</strong>, כולל מי ששילם.</span></div>' +
        '<div class="vpg-fcard"><b>💬 WA למי שלא שילם החודש</b><span>שולח <strong>רק לחייבים</strong> — בדיוק כמו התזכורת האוטומטית.</span></div>' +
      ...
      '</div>' +
      '<div class="vpg-box tip"><div class="bt">🎯 מי מקבל "WA למי שלא שילם החודש"?</div>' +
        'הכפתור שולח בדיוק לאותם דיירים שהתזכורת <strong>האוטומטית</strong> הייתה שולחת להם. הוא <strong>מדלג</strong> על:' +
        '<ul><li><strong>מי ששילם</strong> את מלוא סכום החודש (בבנק או ידנית).</li>' +
        '<li><strong>מי שנמצא ביתרת זכות</strong> — למשל דייר ששילם כמה חודשים מראש. גם אם לא נקלט ממנו תשלום החודש, יתרת הזכות מכסה את דמי החודש ולכן הוא אינו חייב — ולא תישלח אליו תזכורת.</li>' +
        '<li><strong>דיירים מושהים ⏸</strong> — אלא אם קיים להם חשבון נוסף פעיל (מים/חשמל) שטרם שולם, שאז תישלח תזכורת רק על אותו חשבון.</li></ul>' +
        'דייר ששילם <strong>חלקית</strong> כן יקבל תזכורת — על היתרה בלבד.</div>' +
      '<div class="vpg-box tip"><div class="bt">💡 הבחנה חשובה: "לכולם" מול "רק לחייבים"</div>"WA לכולם" הוא שליחה יזומה לכל הרשימה (שימושי להודעה כללית). "WA למי שלא שילם החודש" הוא לגבייה שוטפת — הוא לא יטריד דייר שכבר שילם או שנמצא בזכות.</div>' +
      ...
      '<h3>סגירת חודש — מתי החוב באמת מתעדכן</h3>' +
      '<p class="vpg-lead">זו אחת הנקודות שהכי חשוב להבין, כי היא מסבירה למה מספר החוב לא זז מיד אחרי ייבוא קובץ הבנק.</p>' +
      '<div class="vpg-box warn"><div class="bt">⚠️ ייבוא בנק ≠ עדכון החוב המצטבר</div>ייבוא קובץ בנק מעדכן <strong>מיד</strong> את הסטטוס החודשי (שילם / חלקי / לא שילם), אבל <strong>לא</strong> מזיז את מספר החוב המצטבר (עמודת "חוב"). זה תקין ומכוון — החוב המצטבר זז רק ב<strong>סגירת חודש</strong>.</div>' +
      '<p>יש שתי דרכים שבהן חודש נסגר:</p>' +
      '<table class="vpg-t"><tr><th>דרך</th><th>מתי</th><th>מה קורה</th></tr>' +
        '<tr><td><strong>אוטומטי</strong></td><td>ב-1 בכל חודש</td><td>המערכת סוגרת אוטומטית את החודש <strong>הקודם</strong> — עבור כל בניין.</td></tr>' +
        '<tr><td><strong>ידני</strong></td><td>מתי שתרצו</td><td>כפתור <strong>"📅 סגור חודש קודם עכשיו"</strong> (בכרטיס ייבוא הבנק) — סוגר את החודש הקודם לבניין שלכם בלבד, בלי לחכות ל-1 בחודש.</td></tr>' +
      '</table>' +
      '<p><strong>מה בדיוק קורה בסגירת חודש</strong> (לכל דייר, עבור החודש הנסגר):</p>' +
      '<ul><li><strong>לא שילם</strong> → דמי החודש מצטברים לחוב המצטבר.</li>' +
      '<li><strong>שילם חלקית</strong> → רק ההפרש (היתרה) מצטבר לחוב.</li>' +
      '<li><strong>שילם במלואו</strong> → החודש נסגר, החוב לא משתנה.</li>' +
      '<li><strong>שילם ביתר</strong> → העודף <strong>מקזז את החוב הקודם</strong> של הדייר (ואם אין חוב — נשמר כיתרת זכות). כלומר: קודם משולמים דמי החודש, והעודף הולך לכיסוי חוב ישן.</li></ul>' +
      '<div class="vpg-box ok"><div class="bt">✅ דוגמה</div>דייר עם חוב קודם 1000 ₪, דמי חודש 100 ₪, שילם החודש 800 ₪ → בסגירת החודש: 100 ₪ סוגרים את החודש, ו-700 ₪ הנותרים מקזזים את החוב הקודם (שיורד ל-300 ₪).</div>' +
      '<div class="vpg-box tip"><div class="bt">💡 הגנה מפני סגירה כפולה</div>סגירת אותו חודש פעמיים (למשל לחיצה חוזרת על הכפתור) לא תצבור חוב פעמיים — המערכת זוכרת אילו חודשים כבר נסגרו ומדלגת עליהם.</div>' +
      '<div class="vpg-box warn"><div class="bt">⚠️ הכפתור סוגר תמיד את החודש הקודם</div>הכפתור הידני סוגר את החודש שלפני החודש הנוכחי (למשל ביולי — הוא סוגר את יוני). אין כרגע אפשרות לסגור חודש שרירותי אחר.</div>'
  },
  {
  ...
  },
  {
    ...
    body:
      ...
      '<tr><td>חודש לשליחה</td><td><strong>אוטומטי</strong> (מומלץ): עד ה-10 = חודש קודם, אחריו = נוכחי. או בחירה ידנית.</td></tr>' +
      '<tr><td>סף חוב חריג (₪)</td><td>דייר שסך חובו שווה או גדול מסכום זה יופיע בכרטיס "חייבים חריגים" במסך הראשי. ברירת מחדל: 1000 ₪.</td></tr></table>' +
      '<div class="vpg-box tip"><div class="bt">🔁 שלח עכשיו</div>מפעיל את השליחה מיד, בלי להמתין למועד המתוזמן.</div>' +
      '<h3>🚨 חייבים חריגים</h3>' +
      '<p>כרטיס "חייבים חריגים" במסך הראשי מציג את הדיירים שסך חובם עבר את הסף שהוגדר. לחיצה עליו פותחת חלון עם:</p>' +
      '<ul><li>שם הדייר וסך החוב.</li>' +
      '<li>פירוט החוב לפי חודשים שלא שולמו, כולל תשלומים חלקיים, חשבונות נוספים ו<strong>חוב התחלתי / פתוח</strong> שהוזן ידנית.</li>' +
      '<li>כפתור "📨 שלח התראה" — שליחת הודעה בוואטסאפ, במייל, או הפקת מכתב להדפסה.</li>' +
      '<li>היסטוריית ההתראות שנשלחו לדייר: תאריך, ערוץ וסכום החוב באותו מועד.</li></ul>' +
      '<div class="vpg-box tip"><div class="bt">✏️ עריכה לפני שליחה</div>ניתן לערוך את נוסח ההודעה בחלון השליחה. העריכה חלה על השליחה הנוכחית בלבד — לשינוי קבוע ערכו את "תבנית הודעה לחוב חריג" בהגדרות.</div>' +
      '<div class="vpg-box ok"><div class="bt">🛡️ שליחת התראה אינה משנה נתוני תשלום</div>ההתראה היא הודעה בלבד: היא אינה מסמנת חודש כשולם ואינה משנה את החוב. היא נרשמת רק ביומן ההתראות של הדייר.</div>' +
      '<h3>תבנית הודעה לחוב חריג</h3>' +
      '<p>נוסח מכתב ההתראה. משתנים:</p>' +
      '<p><span class="vpg-var">{שם}</span><span class="vpg-var">{חודש}</span><span class="vpg-var">{סה"כ_חוב}</span>' +
  ...
  },
  {
    ...
    body:
      ...
      '<ol class="vpg-steps">' +
        ...
        '<li><strong>מעקב ממתינים.</strong> "WA למי שלא שילם החודש" + סימון מזומן ידני.</li>' +
