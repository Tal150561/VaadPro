...
(function () {
  ...
  },
  {
    ...
    body:
      ...
      '<div class="vpg-box tip"><div class="bt">1️⃣ רק האחרון, רק פעם אחת</div>אפשר לבטל רק את הייבוא האחרון. אחרי ביטול אין "ביטול נוסף" לייבוא שלפניו. ריצה אוטומטית של BankSync שלא מצאה תשלומים חדשים <strong>לא</strong> נחשבת ייבוא ולא מוחקת את אפשרות הביטול.</div>' +
