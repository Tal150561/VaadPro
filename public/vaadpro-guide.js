...
(function () {
  ...
  },
  {
    ...
    body:
      ...
      '<p><strong>מה קורה בפועל בייבוא בנק ידני:</strong> אחרי אישור הייבוא מופיעה שורת החלטה נפרדת: <em>"התקבל תשלום X ₪ עבור &lt;חודש שנסגר&gt; — לזקוף לחוב?"</em> עם שני כפתורים:</p>' +
      '<ul><li><strong>✅ לזקוף לחוב</strong> — זוקף את <strong>מלוא התשלום</strong> כנגד החוב: קודם נסגר החוב של אותו חודש וכל חוב פתיחה קודם, ואם נשאר עודף הוא הופך ל<strong>יתרת זכות</strong>. פעם אחת בלבד, עם הערת שקיפות מתועדת.</li>' +
