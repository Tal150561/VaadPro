...
(function () {
  ...
  },
  {
    ...
    body:
      ...
      '<div class="vpg-box tip"><div class="bt">💡 טעית בחוב התחלתי של דייר?</div>אל תשתמשו בכלי הזה. לתיקון יתרת פתיחה של דייר בודד — <strong>ערכו את הדייר</strong> (שדה "יתרת פתיחה"), או <strong>ייבאו קובץ דיירים מעודכן</strong> עם החובות הנכונים. שתי הדרכים מדויקות ובטוחות. איפוס גורף של החוב ההתחלתי לכל הבניין מתבצע רק דרך התמיכה.</div>' +
